...
public class OperateImage {
	...
	public void cut() throws IOException {
		...
		try {
			String ext = FileTools.getExtFilename(srcpath);
	...
	public String getNewImgPath(String oldImgPath) {
		String newImgPath = "";
		Long id = new Date().getTime();
		String[] extss = oldImgPath.split("\\/");
		String oldfilename = extss[extss.length - 1];
		String ext = FileTools.getExtFilename(oldImgPath);
		ext = ext.toLowerCase();
		long l1 = id / (2000 * 2000);
		long l2 = (id % (2000 * 2000)) / 2000;
		long l3 = id % 2000;
		String filename = String.format("p_%d%d%d.%s", l1, l2, l3, ext);
		newImgPath = oldImgPath.replaceAll(oldfilename, filename);
		return newImgPath;
	}

	public static void main(String[] args) throws Exception {
		String name = "d:\\2.jpg";
		OperateImage o = new OperateImage(20, 20, 900, 600);
		o.setSrcpath(name);
		// o.setSubpath("D:\\22.jpg");
		// o.cut();
		System.out.println("====exts====" + o.getNewImgPath("362536/1340/1565/N1/p_36253613401565.jpg"));
	}
