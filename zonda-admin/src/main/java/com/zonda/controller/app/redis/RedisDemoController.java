package com.zonda.controller.app.redis;
...
public class RedisDemoController extends BaseController {
	...
	/**
	 * 请求接口 http://127.0.0.1:8080/项目名称/appRedisDemo/redisDemo.do demo 展示的在redis存储读取数据的方式，本系统暂时用不到redis，此redis接口可根据实际业务需求选择使用 具体redis的应用场景->百度下即可
	 */
