package com.zonda.controller.system.head;
...
import com.zonda.service.system.fhsms.FhsmsManager;
...
import com.zonda.util.SmsUtil;
import com.zonda.util.Tools;
import com.zonda.util.Watermark;
import com.zonda.util.mail.SimpleMailSender;

/**
 * 类名称：HeadController 创建人：FH 313596790Q 修改时间：2015年11月23日
 * 
 * @version
 */
@Controller
...
public class HeadController extends BaseController {
	...
	public Object getList() {
		...
		try {
			...
			pdList.add(pds);
			map.put("list", pdList);
			map.put("fhtaskCount", taskService.createTaskQuery().taskCandidateOrAssigned(Jurisdiction.getUsername()).active().orderByTaskId().desc().count());// 待处理任务数
