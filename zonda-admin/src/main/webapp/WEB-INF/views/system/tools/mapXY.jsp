...
<body>
	<div>
		<table bgcolor="#E3E4D8" width="100%">
			<tr>
				<td style="font-size: 2px;">经度：</td>
				<td><input id="ZUOBIAO_Y" value="" type="text" style="width:150px;" /></td>
				<td style="font-size: 2px;">纬度：</td>
				<td><input id="ZUOBIAO_X" value="" type="text" style="width:150px;" /></td>
				<td><input type="button" value="确定" onclick="choose();" /></td>
				<td width="200">
					<input type="text" id="suggestId" size="20" value="这里输入搜索地址" placeholder="这里输入搜索地址" style="width:195px;" />
					<div id="searchResultPanel" style="width:150px;height:auto;"></div>
				</td>
			</tr>
		</table>
	</div>
...
<script type="text/javascript">
	...
	function handleError(error) {
		map.centerAndZoom("杭州市", 12); // 初始化地图,设置城市和地图级别。
	}
	...
	try {
		...
		console.log("调用百度地图API定位默认地市异常：" + err);
		alert("位置信息定位失败，请确认已打开GPS后再次尝试");
	}
