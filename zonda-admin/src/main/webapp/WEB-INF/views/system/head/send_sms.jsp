		...
		<div class="main-content">
			...
			<div id="zhongxin">
				...
				<table style="width:99%;margin-top: 12px;margin-left: 9px;">
					...
					<tr>
						<td style="text-align: center;"><a class="btn btn-mini btn-primary" onclick="sendSms();">发送</a> <a class="btn btn-mini btn-danger" onclick="top.Dialog.close();">取消</a> <label style="float:left;padding-left: 32px;"><input name="form-field-radio" id="form-field-radio1" onclick="setType('1');" class="ace" checked="checked" type="radio" value="icon-edit"><span class="lbl">短信接口1</span></label> <label style="float:left;padding-left: 5px;"><input name="form-field-radio" id="form-field-radio2" onclick="setType('2');" class="ace" type="radio" value="icon-edit"><span class="lbl">短信接口2</span></label> <label style="float:left;padding-left: 15px;"><input name="form-field-checkbox" type="checkbox" id="allusers" class="ace" onclick="isAll();" /><span class="lbl">全体用户</span></label></td>
					</tr>
				</table>
			</div>
