									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false"> <i class="bigger-110 ace-icon fa fa-angle-right" data-icon-hide="ace-icon fa fa-angle-down" data-icon-show="ace-icon fa fa-angle-right"></i> &nbsp;连接数据库
												</a>
											</h4>
										</div>
											...
											<div class="panel-body">
												<div style="float: left;">
													<table>
														<tr>
															<td id="fhdb">数据库：</td>
															<td><select name="dbtype" id="dbtype" data-placeholder="请选择数据库" style="vertical-align:top;width: 100%;" onchange="selectDb(this.value)">
												...
												<div style="float: left;margin-top:15px;margin-left: 20px;">
													<a class="btn btn-success btn-sm" onclick="connDb();"> 连接 </a>
												</div>
											</div>
										</div>
									</div>
