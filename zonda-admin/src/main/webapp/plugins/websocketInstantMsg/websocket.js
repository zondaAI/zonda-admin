var websocket;
var isCreatw = false;// 启动标识
var title = "";// 聊天窗口标题
var win;// 展示窗口
var input;
var isQj = true;// 全局对话标识
var toUser = "";
...
Ext.define('MessageContainer', {
	...
	tpl : [ '<div class="l-im-message-warn">​欢迎使用zonda Admin 即时通讯系统。</div>', '<tpl for=".">', '<div class="l-im-message">', '<div class="l-im-message-header l-im-message-header-{source}">{from}  {timestamp}</div>', '<div class="l-im-message-body">{content}</div>', '</div>', '</tpl>' ],
	messages : [],
