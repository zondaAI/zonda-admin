...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
        	// Edit the Close Event--by zonda 2016:11:17 17:46:28
    		// window.location.href = "./";
        	// top.Dialog.getInstance('0').okButton.onclick.apply(top.Dialog.getInstance('0').okButton,[]);
        	top.Dialog.getInstance('0').cancelButton.onclick.apply(top.Dialog.getInstance('0').cancelButton,[]);
        	// top.Dialog.close();
        },
