package com.zonda.controller.weixin;
...
import com.zonda.service.weixin.command.CommandService;
import com.zonda.service.weixin.imgmsg.ImgmsgService;
import com.zonda.service.weixin.textmsg.TextmsgService;
...
public class WeixinController extends BaseController {
	...
	public void getGz(PrintWriter out) {
		...
		try {
			...
			/*
			 * PrintWriter pw; try { pw = new PrintWriter( new FileWriter( "e:/gz.txt" ) ); pw.print(jsonObject.getString("total")); pw.close(); } catch (IOException e) { // TODO Auto-generated catch block e.printStackTrace(); } out.write("success"); out.close();
			 */
		}
		catch (Exception e) {
			logger.error(e.toString(), e);
